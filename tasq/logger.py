...
class MakeCappedFileHandler(RotatingFileHandler):
    def __init__(
        ...
        RotatingFileHandler.__init__(self, filename, mode, max_size, backup_count, encoding, delay)


class GlobalLogger:
    def __init__(self, loglevel=DEFAULT_LOGLEVEL, fmt=DEFAULT_FORMAT, logpath=DEFAULT_LOGPATH):
